...
def calculate_keys(p, q, nbits):
    ...
    while True:
        ...
        # limit size of e to integer value
        e = getprime(min(32, max(8, nbits/2)))
...
def unpicklechops(string):
    ...
    return loads(base64.decodestring(string))
...
def encrypt(message, key):
    ...
    return encrypt_int(bytes2int(message), key['e'], key['n'])
...
def decrypt(cypher, key):
    ...
    return int2bytes(decrypt_int(int(cypher, 16), key['d'], key['p']*key['q']))

...
$(document).ready(function() {
	...
	// -------------------------------------------------------------------
		...
		$('.tipInclude').cluetip({attribute: 'rel', showtitle: false, arrows: true}); // external file included tips
		*/
...
function searchInputEffect() {
  var	searchFocus = false,
    searchHover = false,
    searchCtnr = $('.Search');
    searchInput = searchCtnr.find('.SearchInput'),
    searchSubmit = searchCtnr.find('.SearchSubmit');
...
function buttonStyles() {
  ...
  // Button Active class (IE 6 needs this)
  styledButtons.mousedown(
      function(){ $(this).addClass('submitBtnActive'); },		// mouseover
      function(){ $(this).removeClass('submitBtnActive'); }	// mouseout
  );
}

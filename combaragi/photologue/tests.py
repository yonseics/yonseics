...
from photologue.models import ImageModel, PhotoSize, PhotoEffect, PhotoSizeCache, PHOTOLOGUE_DIR
...
class PhotoTest(PLTest):
    ...
    def test_paths(self):
        ...
        self.assertEqual(self.pl.cache_url(),
                         settings.MEDIA_URL + PHOTOLOGUE_DIR + '/%s/%s/%s/cache' % (year, month, day))
